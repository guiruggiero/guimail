...
// Checking imports and initializations
// console.log(GEMINI_API_KEY, EMAIL_GUIMAIL);
...
// exports.guimail = onRequest(functionConfig, async (request, response) => {
  ...
  // const expectedToken = `Bearer ${WORKER_SECRET}`;
  ...
  const from = "gui@gui.com";
  const originalSubject = "Invitation to Sanger Leadership Center tailgate on 10/18";
