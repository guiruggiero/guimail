...
2. **Firebase Cloud Function** (`functions/`) — parses the email, fetches the system prompt from Langfuse, calls Gemini with forced tool use, executes the chosen tool handler, and returns a raw RFC 2822 reply.
